...
ClimbablePhysics::ClimbablePhysics(qreal relative_mass, QObject *parent): ObjectFeature(parent)
{
...
void ClimbablePhysics::handleInternalsChange()
{
    if(m_owner != nullptr){
        ...
        m_databank->physics_packet.append(0.01);
